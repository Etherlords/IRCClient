package irc
{
    public class IRCCommands
    {
		...
		public static const COMMANDS:Vector.<String> = new <String>
																	[
																		PASS, NICK, USER, OPER, MODE, SERVICE, ADMIN, AWAY, INFO,
																		QUIT, SQUIT, JOIN, KICK, PART, TOPIC, NAMES, LIST, INVITE,
																		PING, PONG, PRIVMSG, NOTICE, MOTD, LUSERS, VERSION, STATS,
																		LINKS, TIME, CONNECT, TRACE, WHOIS
																	];
    }
}
